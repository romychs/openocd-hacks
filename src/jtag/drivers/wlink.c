...
{	
	...
	if (pReadData(0, 1, rxbuf, &len))
	{
		...
		case 4:
			...
			break;
		case 18: 
			wlink_name="WCH-LinkE-CH32V305 mod:RV";
			break;
		default:
			LOG_ERROR("WL Unknown WCH-LINK type: %d;", rxbuf[5]);
			goto error_wlink;
			break;
		}
		...
		case 1:
		{
			...
			if(pReadData(0, 1, rxbuf, &len)){
					...
					// int ret = 
					DMI_OP(0, 0x04, 0x00000020, 2, &oAddr, &oData, &oOP);
					usleep(1000);
		...
		case 3:
		{
			...
			default:
				LOG_ERROR("WL Unknown CH56X riscvchip");
				goto error_wlink;
